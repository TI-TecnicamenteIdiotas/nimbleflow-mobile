...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, int? colorTheme, int? categoryIcon});
}
...
class _$_CategoryModel implements _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, title: $title, colorTheme: $colorTheme, categoryIcon: $categoryIcon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, colorTheme, categoryIcon);
...
abstract class _CategoryModel implements CategoryModel {
  const factory _CategoryModel(
      ...
      final int? colorTheme,
      final int? categoryIcon}) = _$_CategoryModel;
